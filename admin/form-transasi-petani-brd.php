                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="nm_suplayer" class="form-control select2" required oninvalid="this.setCustomValidity('Pilih Subplayer')" oninput="setCustomValidity('')">
                                                    ...
                                                    $query = mysqli_query($koneksi, "select a.nm_suplayer,a.hp,a.panjar_tbs,sum(b.ptg_hutang) as cicilan,(a.panjar_tbs)-sum(b.ptg_hutang) as sisa from ta_suplayer a left join ta_transaksi b on b.nm_suplayer=a.nm_suplayer where a.jenis='petani' GROUP BY a.nm_suplayer");
                                        ...
                                        <div class="col-md-4 mt-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <small>Persen</small>
                                                    <input class="form-control bg-primary text-dark" name="ptg_persen" id="ptg_persen" type="text" value="<?= $persen_petani_brd ?>">
                                                </div>
                                                <div class="col-sm-3">
                                        ...
                                        <div class="col-md-4 mt-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <small>Rp</small>
                                                    <input class="form-control bg-primary text-dark" name="harga" id="harga" type="number" value="<?= $harga_petani_brd ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
