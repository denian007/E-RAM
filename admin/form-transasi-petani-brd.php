                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="nm_suplayer" class="form-control select2" required oninvalid="this.setCustomValidity('Pilih Subplayer')" oninput="setCustomValidity('')">
                                                    ...
                                                    $query = mysqli_query($koneksi, "select DISTINCT a.nm_suplayer,a.hp,(a.panjar_tbs)-sum(b.ptg_hutang) as ptg_hutang from ta_suplayer a left join ta_transaksi b on a.nm_suplayer=b.nm_suplayer where a.jenis='petani' GROUP BY a.nm_suplayer");
