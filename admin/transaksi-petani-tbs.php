                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $query = mysqli_query($koneksi, "select *,MID(time_stamp, 12, 8) AS pukul from ta_transaksi where time_stamp like '%$tahun%' and jenis2='tbs' and jenis like '%petani%' order by time_stamp desc");
                                        ...
                                        ?>
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="transaksi-petani-tbs?hal=hapus&id=<?= $data['id'] ?>" class="btn btn-outline-danger ml-2 bhapus<?= $data['id']; ?>"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <script>
