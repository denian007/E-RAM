...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == "hapus") {
        ...
        $hapus = mysqli_query($koneksi, "DELETE FROM ta_transaksi WHERE id = '$_GET[id]' ");
        if ($hapus) //jika simpan sukses
        {
            ...
            header("location:transaksi-petani-brd?id=hapus-success");
        } else {
            header("location:transaksi-petani-brd?id=hapus-gagal");
        }
    }
};
