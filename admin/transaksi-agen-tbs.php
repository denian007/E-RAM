<?php
include('session.php');
include('read-transaksi-agen.php');
                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a href="form-transasi-agen?komoditas=tbs" class="btn btn-outline-primary"> <i class="fa fa-plus"></i> Tambah Transaksi</a>
                                    </div>
                                </div>
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $query = mysqli_query($koneksi, "select *,MID(time_stamp, 12, 8) AS pukul from ta_transaksi where time_stamp like '%$tahun%' and jenis2='tbs' and jenis like '%agen%' order by time_stamp desc");
