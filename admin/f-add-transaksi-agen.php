...
if (isset($_POST['bsimpan'])) {
...

    {
        ...
        header("location:transaksi-agen-$komoditas?id=add-transaksi-success&suplayer=$nm_suplayer");
    } else {
        ...
        header("location:transaksi-agen-$komoditas?id=add-transaksi-gagal&suplayer=$nm_suplayer");
    }
}
