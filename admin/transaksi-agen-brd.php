<?php
include('session.php');
include('read-transaksi-agen-brd.php');
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Transaksi Agen</h4>
                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a href="form-transasi-agen-brd?komoditas=brd" class="btn btn-outline-primary"> <i class="fa fa-plus"></i> Tambah Transaksi</a>
                                    </div>
                                </div>
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $query = mysqli_query($koneksi, "select *,MID(time_stamp, 12, 8) AS pukul from ta_transaksi where time_stamp like '%$tahun%' and jenis2='brd' and jenis like '%agen%' order by time_stamp desc");
                                        ...
                                        ?>
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="transaksi-agen-brd?hal=hapus&id=<?= $data['id'] ?>" class="btn btn-outline-danger ml-2 bhapus<?= $data['id']; ?>"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
