                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-20">
                            <div class="card-body mb-5">
                                <p class="text-head"></p>
                                <form action="f-add-transaksi-agen.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-12" style="display: none;">
                                            <input type="text" name="jenis" class="form-control" value="agen">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="nm_suplayer" class="form-control select2" required oninvalid="this.setCustomValidity('Pilih Subplayer')" oninput="setCustomValidity('')">
                                                    ...
                                                    $query = mysqli_query($koneksi, "select a.nm_suplayer,a.hp,a.panjar_tbs,sum(b.ptg_hutang) as cicilan,(a.panjar_tbs)-sum(b.ptg_hutang) as sisa from ta_suplayer a left join ta_transaksi b on b.nm_suplayer=a.nm_suplayer where a.jenis='agen' GROUP BY a.nm_suplayer");
                                                            ...
                                                            jQuery('select[name="nm_suplayer"]').on('change',
                                                                function() {
                                                                    ...
                                                                    jQuery('select[name="panjar_tbs"]').html(
                                                                        ...
                                                                        ambil_komponen1[set].cicilan + '</option>');
                                                                });
                                                        });
                                                    </script>
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <b>Tanggal</b>
                                                <input type="date" class="form-control" name="tanggal" value="<?= date('Y-m-d') ?>" required oninvalid="this.setCustomValidity('Pilih Tanggal')" oninput="setCustomValidity('')">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mt-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <small>Kg</small>
                                                    <input class="form-control bg-primary text-dark uang" name="tbg_masuk" id="tbg_masuk" type="text" placeholder="0" value="0" required oninvalid="this.setCustomValidity('Masukan Timbangan Masuk')" oninput="setCustomValidity('')">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <small>Kg</small>
                                                    <input class="form-control bg-primary text-dark uang" name="tbg_keluar" id="tbg_keluar" type="text" value="0" placeholder="0" required oninvalid="this.setCustomValidity('Masukan Timbangan Masuk')" oninput="setCustomValidity('')">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <small>Kg</small>
                                                    <input class="form-control uang" name="tbg_kotor" id="tbg_kotor" type="text" value="0" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <!--  -->
                                        ...
                                        <div class="col-md-4 mt-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <small>Persen</small>
                                                    <input class="form-control bg-primary text-dark" name="ptg_persen" id="ptg_persen" type="text" value="<?= $persen_agen_brd ?>">
                                                </div>
                                                <div class="col-sm-3">
                                        ...
                                        <div class="col-md-4 mt-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <small>Rp</small>
                                                    <input class="form-control bg-primary text-dark" name="harga" id="harga" type="number" value="<?= $harga_agen_brd ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <div class="col-md-12 mt-3" style="text-align: end;">
                                            <button type="button" class="btn btn-outline-danger" onclick="history.back(-1)"><i class="fas fa-undo-alt"></i> Kembali</button>
