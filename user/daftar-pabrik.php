            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Daftar Pabrik</h4>
                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a href="#" class="btn btn-outline-primary"> <i class="fa fa-plus"></i> Tambah Pabrik</a>
                                    </div>
                                </div>
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <thead>
                                        <tr class="align-middle text-center bg-primary text-dark">
                                            <th width="5">No</th>
                                            <th width="150">Nama Pabrik</th>
                                            <th width="150">Alamat</th>
                                            <th width="50">Nama Manajer</th>
                                            <th width="50">Biaya Operasional</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="align-middle">
                                                ...
                                                <td><?= $data['nm_pabrik_singkat']; ?> - <?= $data['nm_full_pabrik']; ?></td>
                                                <td><?= $data['alamat_pabrik']; ?></td>
                                                <td><?= $data['manager_pabrik']; ?></td>
                                                <td>Rp.<?= rp($data['uang_jalan']); ?>,-</td>
                                                <td class="text-center">
                                                    <a href="#" data-toggle="modal" data-target="#modalEditPabrik<?= $data['id'] ?>" class="btn btn-outline-primary"><i class="fa fa-edit"></i></a>
                                                    <a href="daftar-pabrik?hal=hapus&id=<?= $data['id'] ?>" class="btn btn-outline-danger ml-2 bhapus<?= $data['id']; ?>"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <script>
                                                $('.bhapus<?= $data['id']; ?>').on('click', function(e) {
                                                    ...
                                                    Swal.fire({
                                                        title: 'Perhatian !',
                                                        text: "Yanin ingin menghapus Pabrik <?= $data['nm_pabrik_singkat'] ?>?",
                                                        icon: 'warning',
                                            ...
                                            <?php include('modal-edit-pabrik.php'); ?>
                                        <?php endwhile; ?>
