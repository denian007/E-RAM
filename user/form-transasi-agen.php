                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <small>Persen</small>
                                                    <input class="form-control bg-primary text-dark" name="ptg_persen" id="ptg_persen" type="text" value="<?= $persen_agen_tbs ?>">
                                                </div>
                                                <div class="col-sm-3">
                                        ...
                                        <div class="col-md-4 mt-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <small>Rp</small>
                                                    <input class="form-control bg-primary text-dark" name="harga" id="harga" type="number" value="<?= $harga_agen_tbs ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
