...
if (isset($_POST['bsimpan'])) {
    ...
    if ($edit) //jika edit sukses
    {
        ...
        header("location:transaksi-petani-$komoditas?id=update-transaksi-success&suplayer=$nm_suplayer");
    } else {
        ...
        header("location:transaksi-petani-$komoditas?id=update-transaksi-gagal&suplayer=$nm_suplayer");
    }
}
