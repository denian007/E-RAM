            ...
            <div class="card-box ">
                ...
                <table style="color:#000;width:100%;">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $query = mysqli_query($koneksi, "select * from ta_transaksi where jenis2='$_GET[komoditas]'");
                    ...
                    <tfoot>
                        <?php
                        $no = 1;
                        $query = mysqli_query($koneksi, "select sum(tbg_masuk) as tbg_masuk,sum(tbg_keluar) as tbg_keluar,sum(tbg_bersih) as tbg_bersih from ta_transaksi where jenis2='$_GET[komoditas]'");
                        while ($data = mysqli_fetch_array($query)) :
                        ?>
                            <tr>
